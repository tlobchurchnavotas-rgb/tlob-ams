...
import { fetchPublicEvents, searchPublicMembers, submitPublicVisitor } from "../publicRegisterApi.js";
...
export default function PublicRegisterPage() {
  ...
  useEffect(() => {
    document.title = "Visitor registration · TLOB AMS";
  }, []);
    ...
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "'DM Sans','Segoe UI',sans-serif", padding: "28px 16px 48px" }}>
      ...
      <div style={{ maxWidth: 460, margin: "0 auto" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 22 }}>
          <img src={CHURCH_LOGO_SRC} alt="TLOB" style={{ width: 52, height: 52, borderRadius: "50%", objectFit: "cover", border: `3px solid ${C.border}` }} />
          <div>
